...
syn keyword ForbidenFunc malloc free opendir readdir closedir stat lstat getpwuid getgrgid listxattr getxattr time ctime readlink open close read write perror strerror exit printf
